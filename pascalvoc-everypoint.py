...
if args.savePath is not None:
    ...
    savePath = os.path.join(currentPath, 'results-everypoint-{}'.format(iouThreshold))
# Validate savePath
...
##python3 pascalvoc-11point.py -gt /home/luigy/luigy/igor/AP_Yamaha_Luigy/new/gts -det /home/luigy/luigy/igor/AP_Yamaha_Luigy/new/new_dts -imgsize 640,480 -t 0.50